...
void setup_tim3(void) {
    ...
    GPIOC->MODER &= ~(0xFF << (6 * 2));  
    GPIOC->MODER |= (0xAA << (6 * 2));   
...
void setrgb(int rgb) {
    ...
    TIM1->CCR1 = 2400 - ((r * 2400) / 99);
    TIM1->CCR2 = 2400 - ((g * 2400) / 99);
    TIM1->CCR3 = 2400 - ((b * 2400) / 99);
}
...
void TIM6_DAC_IRQHandler(void) {
    ...
    // Ensure proper signed arithmetic before shifting
    samp = samp * (int)volume;  
    samp = (samp >> 18) + 1200; 
